require('nvim-treesitter.configs').setup {
  ensure_installed = {"lua", "python", "javascript", "markdown", "markdown_inline"},
    ...
    highlight = {
        ...
        -- enable = true,
        enable = true,
        -- disable = { "lua", "python", "markdown", "markdown_inline", "javascript", },
        disable = {"lua", "python", "javascript"},
...
vim.api.nvim_set_hl(0, "@text.title.1.markdown", {link = "Tag"})
vim.api.nvim_set_hl(0, "@text.title.1.marker.markdown", {link = "Tag"})
vim.api.nvim_set_hl(0, "@text.title.2.markdown", {link = "Macro"})
vim.api.nvim_set_hl(0, "@text.title.2.marker.markdown", {link = "Macro"})
